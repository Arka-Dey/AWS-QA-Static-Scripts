...
public class VerifyAllSanctionFromRFxPage extends BaseClass_Web {
	...
	public void AllSanctionFromRFxPage(String no)
			throws Throwable {
		...
		pagesUpAndRunning.commonLogin(PagesUpAndRunningComponent.getDataFromPropertiesFile("SNCreator", filePath),PagesUpAndRunningComponent.getDataFromPropertiesFile("SNCreatorPassword", filePath),"DashBoard_Login", "Creator");
