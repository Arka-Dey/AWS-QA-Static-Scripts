...
public class VerifySupplierOrderPages extends BaseClass_Web {
	...
	public void SupplierPages(String no)
			throws Throwable {
		...
		pagesUpAndRunning.commonLogin_Supplier(PagesUpAndRunningComponent.getDataFromPropertiesFile("Supplier", filePath),PagesUpAndRunningComponent.getDataFromPropertiesFile("SupplierPassword", filePath),"Supplier_Login", "Supplier");
		universalWait();
