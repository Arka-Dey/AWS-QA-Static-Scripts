...
public class VerifyIndentPending_CompletedWFPage extends BaseClass_Web {
	...
	public void IndentPending_CompletedWFPage(String no)
			throws Throwable {
		...
		pagesUpAndRunning.commonLogin(PagesUpAndRunningComponent.getDataFromPropertiesFile("IndentApprover", filePath),PagesUpAndRunningComponent.getDataFromPropertiesFile("IndentApproverPassword", filePath),"DashBoard_Login", "Creator");
		pagesUpAndRunning.GoToApprovalworkFlowPendingindentAndSearchTheIndent();
