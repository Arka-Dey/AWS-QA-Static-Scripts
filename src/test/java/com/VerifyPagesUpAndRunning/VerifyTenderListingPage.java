...
public class VerifyTenderListingPage extends BaseClass_Web {
	...
	public void TenderListingPage(String no)
			throws Throwable {
		...
		pagesUpAndRunning.commonLogin(PagesUpAndRunningComponent.getDataFromPropertiesFile("TenderCreator", filePath),PagesUpAndRunningComponent.getDataFromPropertiesFile("TenderCreatorPassword", filePath),"DashBoard_Login", "Creator");
