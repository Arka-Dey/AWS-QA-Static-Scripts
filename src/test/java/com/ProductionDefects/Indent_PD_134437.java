...
public class Indent_PD_134437 extends BaseClass_Web{
	...
	public void ProductionDefect_135540(String no) throws Throwable {
		...
		Dynamicity.updateDataIntoPropertyFile("IndentCreator", "RDCIS_AUTOMATION_TC", filePath_4);
		Dynamicity.updateDataIntoPropertyFile("IndentTemplate", "Indigenous Indent (Supply & Service Both) V-004", filePath_4);
		Dynamicity.updateDataIntoPropertyFile("Template", "Live Indigenous Tender (Supply & Service) V-3.1", filePath_4);
...
/**
IndentCreator=RDCIS_AUTOMATION_TC
IndentTemplate=Indigenous Indent (Supply & Service Both) V-004
Template=Live Indigenous Tender (Supply Only) V-3.0
