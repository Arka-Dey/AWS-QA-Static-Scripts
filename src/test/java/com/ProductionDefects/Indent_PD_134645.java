...
public class Indent_PD_134645 extends BaseClass_Web{
	...
	public void ProductionDefect_135540(String no) throws Throwable {
		...
		etenderPRcomponentobj.commonLogin("CREATOR_USER_01", "pass@123", "Indent", "Creator");
		rfqfromintendcomponentobj.navigateToIndentCreation();
		Dynamicity.updateDataIntoPropertyFile("IndentTemplate", "SUPPLY INDENT_2.6", filePath_4);
		...
		etenderPRcomponentobj.commonLogin("CREATOR_USER_01", "pass@123", "Tender", "Creator");
		...
		Dynamicity.updateDataIntoPropertyFile("Template", "BPPL NEW 11.1", filePath_4);
...
/** 134645	Defect	Closed	Severity - 1	BPPL_ Production - Error while creating tender from Indent.
 Indent and Tender creator Username::CREATOR_USER_01
 pass:: pass@123
IndentTemplate=SUPPLY INDENT_2.6
Template=BPPL NEW 11.1
