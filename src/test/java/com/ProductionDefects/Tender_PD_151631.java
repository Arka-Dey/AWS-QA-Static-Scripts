...
public class Tender_PD_151631 extends BaseClass_Web{
	...
	public void ProductionDefect_135540(String no) throws Throwable {
		...
		etenderPRcomponentobj.commonLogin("JSL-DUMMY_VENDOR1", "pass@123", "Profile", "Supplier");
		ProductionDefectobj.viewProfile();
