...
public class Tender_PD_140916 extends BaseClass_Web{
	...
	public void ProductionDefect_135540(String no) throws Throwable {
		...
		Dynamicity.updateDataIntoPropertyFile("tenderID", "4546", filePath_4);
		ProductionDefectobj.openURL("STG");
		etenderPRcomponentobj.commonLogin("HPCL_TC_01", "Pass@123", "PR", "Creator");
	...
	//approving pending tender in 1st approver login	
		...
		etendercomponentobj.nevigateToCorrigendumApproval();
		  etendercomponentobj.SearchTheTenderHomePage();
		  etendercomponentobj.nevigateToApprovalPage();
