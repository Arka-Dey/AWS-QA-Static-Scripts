...
public class Tender_PD_137733 extends BaseClass_Web{
	...
	public void ProductionDefect_135540(String no) throws Throwable {
		...
		etenderPRcomponentobj.commonLogin("RDCIS_SUPER_ADMIN", "Pass@123", "SA", "admin");
		  etendercomponentobj.navigateToconfigurationManagement();
