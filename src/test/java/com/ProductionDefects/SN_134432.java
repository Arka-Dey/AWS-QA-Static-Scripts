...
public class SN_134432 extends BaseClass_Web{
	...
	public void ProductionDefect_134435(String no) throws Throwable {
		...
		dynamicity.templateGroupDetails_And_UpdateTG(user);
		posttendercomponentobj.supplierSelection_SN();
		dynamicity.fillup_Supplier_Specific_Detail();
		ProductionDefectobj.verify_PD134432_FindOutTotal();
		...
		String approver1=pdfResultReport.testData.get("UserTenderApprover1");
		String approver2=pdfResultReport.testData.get("UserTenderApprover2");
		posttendercomponentobj.sendForApprovalUserDefinedSequential_Coordinator(approver1,approver2);
