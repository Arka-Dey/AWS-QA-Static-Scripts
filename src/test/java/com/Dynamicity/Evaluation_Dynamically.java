...
public class Evaluation_Dynamically extends BaseClass_Web {
	...
	public void createEvaluationFromPR_Dynamically(String no)
        ...
        for (String supplier : suppliers) {
        	...
        	dynamicity.evaluateSupplier_Dynamic(supplier, "Approve", "Approve "+supplier+"", 1);
		}
        //***********************************************
		...
		//**********************************************
	        for (String supplier : suppliers) {
	        	System.out.println("supplier: "+supplier);
	        	dynamicity.evaluateSupplier_Dynamic(supplier, "Approve", "Approve "+supplier+"", 2);
			}
		//***********************************************
		etendercomponentobj.enterOverallComment_EvaluatorUser();
		ProductionDefectobj.Logout(Dynamicity.getDataFromPropertiesFile("Environment", filePath_4));
