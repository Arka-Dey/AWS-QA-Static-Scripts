...
public class TG1_TC_Indent_11_Validation_Button_check extends BaseClass_Web{
...
//Creating a new Indent with sequential 1 approver userdefined WF
		...
		rfqfromintendcomponentobj.downloadWFReportValidation();
		
		//validate LifeCycle
//		rfqfromintendcomponentobj.lifeCycleValidation();      //need this to add after fully used indent
		//clone Indent
		rfqfromintendcomponentobj.cloneIndent();
	    rfqfromintendcomponentobj.VerifyIndentStatus("Draft");
		rfqfromintendcomponentobj.VerifyIndentPreviewInDraftState();
		rfqfromintendcomponentobj.Add_1BOM_Item();   //adding item
		rfqfromintendcomponentobj.DeletingOneItem_BOM_Item();
		rfqfromintendcomponentobj.IndentTG1_Submit();
		rfqfromintendcomponentobj.SystemIndentNoSaveNew();
		rfqfromintendcomponentobj.NoApproval_IndentWF();
		rfqfromintendcomponentobj.enterIndentNoInSearch();
