...
public class TC_Direct_Auction_006_E2ESameSBPAndLotLumpSumBidding extends BaseClass_Web{
	...
	public void initializeRepository() throws Exception {		
		...
		reportDetails.put("Test Script Revision No", "12");
	...
	@Test(description = "TC_Auction_012_E2ESameSBPAndLotLumpSumBiddingTypeTest")
  public void TC_Auction_012_E2ESameSBPAndLotLumpSumBiddingTypeTest(String no) throws Throwable {
...
initializeRepository();
	  ...
	  auctioncomponentobj.enterMandatoryFieldsInEventDetailPage("12500000", decvalue, "RANK BIDDING-SAME SBP");
	  ...
	  auctioncomponentobj.settingNewBidAsRateWise("4340000","4340000","4340000");
	  ...
	  auctioncomponentobj.Activate_Aution(AuctionDate);
	  auctioncomponentobj.clickOnDetailsButton(decvalue);
	  auctioncomponentobj.settingNewBidAsRateWise("4300000","4300000","4300000");
	  etendercomponentobj.tenderLogout();
	  ...
	  auctioncomponentobj.NavigaterToAuctionParcipitation();
	  auctioncomponentobj.clickOnDetailsButton(decvalue);
	  auctioncomponentobj.settingNewBidAsRateWise("4260000","4260000","4260000");
	  etendercomponentobj.tenderLogout();
