...
public class TC_MSN_08_Amend_MSN extends BaseClass_Web{
	...
	/**  needs to be updated later according to buisness	
		ProductionDefectobj.openURL(ProductionDefectComponent_QA.getDataFromPropertiesFile_PD("Environment"));
		ProductionDefectobj.commonLogin(ProductionDefectComponent_QA.getDataFromPropertiesFile_PD("SNCreator"), "SN", "SNCreator");
		...
		ProductionDefectobj.amendMSN();
		ProductionDefectobj.SanctionsupplierOrgNameWiseSelection("CTS");
