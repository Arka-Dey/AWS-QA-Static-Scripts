...
public class TG1_TC_Indent_12_Creation_with_approval_Scenarios_Validation extends BaseClass_Web{
...
//Creating a new Indent with sequential 1 approver userdefined WF
		...
		rfqfromintendcomponentobj.ApprovedAndMarkForRFQ();
		...
		//Revert back To IC
				...
				rfqfromintendcomponentobj.revertBacktoIC();
				etendercomponentobj.tenderLogout();
				
		//	Verifying the indent status
				rfqfromintendcomponentobj.IndentcreatorLogin();
				rfqfromintendcomponentobj.navigateToIndentListing();
				rfqfromintendcomponentobj.enterIndentNoInSearch();
