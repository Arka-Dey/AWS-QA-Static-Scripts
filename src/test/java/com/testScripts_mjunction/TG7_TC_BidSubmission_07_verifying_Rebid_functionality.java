...
public class TG7_TC_BidSubmission_07_verifying_Rebid_functionality extends BaseClass_Web{
	...
	public void Verifying_Rebid_functionality_TG7(String no) throws Throwable {
	...
	//Rebid functionality verification
		...
		etendercomponentobj.TG7_Bid_submission_during_Rebid();
		etendercomponentobj.navigate_to_bidList_page();
		etendercomponentobj.enterTenderIdInSearch_bidsubmission();
		etendercomponentobj.submittedBid_Tab_Validation();
