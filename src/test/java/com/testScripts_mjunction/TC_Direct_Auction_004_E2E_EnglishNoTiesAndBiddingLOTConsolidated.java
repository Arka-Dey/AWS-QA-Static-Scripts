...
public class TC_Direct_Auction_004_E2E_EnglishNoTiesAndBiddingLOTConsolidated extends BaseClass_Web {
	...
	@Test(description = "TC_Auction_004:Verify End to End flow with Auction Rule as 'English-No Ties' and bidding type 'LOT_Consolidated'")
