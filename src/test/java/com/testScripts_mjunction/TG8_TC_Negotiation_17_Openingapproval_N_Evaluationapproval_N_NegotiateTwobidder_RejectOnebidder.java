...
public class TG8_TC_Negotiation_17_Openingapproval_N_Evaluationapproval_N_NegotiateTwobidder_RejectOnebidder extends BaseClass_Web{
	...
	public void Tender_Evaluation_with_OpeningApproval_N_Evaluationapproval_N_NegotiateTwobidder_RejectOnebidder_TG8(String no) throws Throwable {
...
//Creating a new Indent with No approval
	...
	//Evaluation: Cover 2 work flow
		...
		etendercomponentobj.enterTenderIdInSearch();
		etendercomponentobj.clickEvaluationSettingsLink();
		etendercomponentobj.Submitevalsettings_ConfirmationPopUpValidation_new();   //etendercomponentobj.Submitevalsettings_ConfirmationPopUpValidation();
		etendercomponentobj.enterTenderIdInSearch();
