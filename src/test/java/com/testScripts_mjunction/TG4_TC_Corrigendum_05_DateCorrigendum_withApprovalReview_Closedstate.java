...
public class TG4_TC_Corrigendum_05_DateCorrigendum_withApprovalReview_Closedstate extends BaseClass_Web{
	...
	public void Date_Corrigendum_approval_review_closed_state_TG4(String no) throws Throwable {
...
//Creating a new tender with approval type Not Required
		...
		etendercomponentobj.Tender_WithOptionalItemsAndQtyEditableDateSchedule(6,10,42);
		etendercomponentobj.Tender_PrebidDiscussionTab_Verifying_TG4(7,8);
