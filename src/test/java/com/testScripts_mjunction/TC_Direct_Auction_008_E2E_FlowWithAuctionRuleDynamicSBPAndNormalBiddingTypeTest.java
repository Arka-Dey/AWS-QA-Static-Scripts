...
public class TC_Direct_Auction_008_E2E_FlowWithAuctionRuleDynamicSBPAndNormalBiddingTypeTest extends BaseClass_Web{
	...
	@Test(description = "TC_Auction_019: E2E_FlowWithAuctionRuleDynamicSBPAndNormalBiddingTypeTest")
  public void validateWorkFlowWithAuctionRuleDynamicSBPAndNormalBiddingTypeTest(String no) throws Throwable {
	  ...
	  auctioncomponentobj.enterMandatoryFieldsInEventDetailPage("2000000", decvalue, "RANK BIDDING-DYNAMIC SBP");
	  
	  auctioncomponentobj.validateAuctionDetailsPageElementsForDynamicSBPRule("2000000", "4600000", "Reserve price must be < 4500000");
