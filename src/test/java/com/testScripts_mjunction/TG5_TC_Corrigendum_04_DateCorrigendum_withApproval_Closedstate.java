...
public class TG5_TC_Corrigendum_04_DateCorrigendum_withApproval_Closedstate extends BaseClass_Web{
	...
	@Test(description = "Date_Corrigendum_approval_closed_state_RFQ_from_Indent")
	public void Date_Corrigendum_approval_closed_state_TG5(String no) throws Throwable {
...
//Creating a new Indent with No approval
	...
	//Create and publish RFQ from indent
		...
		rfqfromintendcomponentobj.PublishTender_from_indent_withRFQ_TG5("Indigenous Tender (Supply Only) V-1.0",5,6,40);
