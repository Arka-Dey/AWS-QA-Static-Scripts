...
public class TC_Direct_Auction_005_E2E_SameSBPAndLotPriceBiddingTypeTest extends BaseClass_Web{
	...
	public void initializeRepository() throws Exception {		
		...
		reportDetails.put("Test Script Revision No", "11");
	...
	@Test(description = "TC_Auction_011_E2E_SameSBPAndLotPriceBiddingTypeTesT")
  public void validateSameSBPAndLotPriceBiddingTypeTesT(String no) throws Throwable {
     ...
     initializeRepository();
	  ...
	  auctioncomponentobj.enterMandatoryFieldsInEventDetailPage("50500000000", decvalue, "RANK BIDDING-SAME SBP");
	  ...
	  auctioncomponentobj.NavigaterToAuctionParcipitation();
	  auctioncomponentobj.clickOnDetailsButton(decvalue);
	  auctioncomponentobj.settingNewBidAsRateWise("4000000","4000000","4000000");
	  etendercomponentobj.tenderLogout();
