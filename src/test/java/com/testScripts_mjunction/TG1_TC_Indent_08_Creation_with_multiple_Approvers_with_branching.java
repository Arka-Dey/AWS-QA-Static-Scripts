...
//				//sent for p1 branching
//				rfqfromintendcomponentobj.IndentapproverLogin(pdfResultReport.testData.get("Approver3"));
//				rfqfromintendcomponentobj.GoToApprovalworkFlowPendingindentAndSearchTheIndent();
//				rfqfromintendcomponentobj.clickDetailLinkInApprovalListPage();
//				rfqfromintendcomponentobj.oneaproverBranching("Mr Indent Approver test");
//				etendercomponentobj.tenderLogout();
//				
//				//approve p1 approver
//				rfqfromintendcomponentobj.IndentapproverLogin(pdfResultReport.testData.get("Approver3"));
...
//				etendercomponentobj.tenderLogoutOld();
//				
//				//sent for p2 branching
//				rfqfromintendcomponentobj.IndentapproverLogin(pdfResultReport.testData.get("Approver4"));
//				rfqfromintendcomponentobj.GoToApprovalworkFlowPendingindentAndSearchTheIndent();
//				rfqfromintendcomponentobj.clickDetailLinkInApprovalListPage();
//				rfqfromintendcomponentobj.threeaproverBranching("Mr Indent Approver test","Mr Test Approver01","Mr Test Approver02");
//				etendercomponentobj.tenderLogout();
//				
//				//action by branch b1(S2) user
//				rfqfromintendcomponentobj.IndentapproverLogin();
//				rfqfromintendcomponentobj.GoToApprovalworkFlowPendingindentAndSearchTheIndent();
//				rfqfromintendcomponentobj.clickDetailLinkInApprovalListPage();
//				rfqfromintendcomponentobj.sendBackToApprover("Indent Process Is Approved by branch user b1(P2)"); 
//				etendercomponentobj.tenderLogoutOld();
//				
//				//sent for p3 branching
//				rfqfromintendcomponentobj.IndentapproverLogin(pdfResultReport.testData.get("Approver4"));
//				rfqfromintendcomponentobj.GoToApprovalworkFlowPendingindentAndSearchTheIndent();
//				rfqfromintendcomponentobj.clickDetailLinkInApprovalListPage();
//				rfqfromintendcomponentobj.threeaproverBranching("Mr Indent Approver test","Mr Test Approver01","Mr Test Approver02");
//				etendercomponentobj.tenderLogout();
//				
//				//action by branch b4(P3) user
//				rfqfromintendcomponentobj.IndentapproverLogin();
//				rfqfromintendcomponentobj.GoToApprovalworkFlowPendingindentAndSearchTheIndent();
//				rfqfromintendcomponentobj.clickDetailLinkInApprovalListPage();
//				rfqfromintendcomponentobj.sendBackToApprover("Indent Process Is Approved by branch user b4(P3)"); 
//				etendercomponentobj.tenderLogoutOld();
//				
//				//action by branch b5(P3) user
//				rfqfromintendcomponentobj.IndentapproverLogin(pdfResultReport.testData.get("Approver1"));
//				rfqfromintendcomponentobj.GoToApprovalworkFlowPendingindentAndSearchTheIndent();
//				rfqfromintendcomponentobj.clickDetailLinkInApprovalListPage();
//				rfqfromintendcomponentobj.sendBackToApprover("Indent Process Is Approved by branch user b5(P3)"); 
//				etendercomponentobj.tenderLogoutOld();
//				
//				//approve p3 approver
//				rfqfromintendcomponentobj.IndentapproverLogin(pdfResultReport.testData.get("Approver4"));
