...
public class TG6_TC_BidSubmission_07_verifying_Rebid_functionality extends BaseClass_Web{
	...
	public void Verifying_Rebid_functionality_TG6(String no) throws Throwable {
	...
	//Rebid functionality verification
		...
		etendercomponentobj.TG6_Bid_submission_during_Rebid();
		etendercomponentobj.navigate_to_bidList_page();
		etendercomponentobj.enterTenderIdInSearch_bidsubmission();
		etendercomponentobj.submittedBid_Tab_Validation();
