...
public class TG1_TC_Negotiation_14_Openingapproval_N_Evaluationapproval_Y_Negotiate_All_bidder extends BaseClass_Web{
	...
	//Creating a new Indent with No approval
		...
		etendercomponentobj.evaluateSupplier("CTS", "Negotiate", "Negotiate with CTS", 1);
		etendercomponentobj.evaluateSupplier("TCS", "Negotiate", "Negotiate with TCS", 1);
		...
		etendercomponentobj.negotiation_dateSchedule(10, 15);
		...
		//Ensure suppliers cannot participate in negotiation before the negotiation start date. from submitted bid tab
		etendercomponentobj.commonLogin("tech_auto_01");
		etendercomponentobj.navigate_to_bidList_page();
		//etendercomponentobj.enterTenderIdInSearch_bidsubmission();
		etendercomponentobj.submittedBid_Tab_Validation();
		etendercomponentobj.BidNoSave();
		etendercomponentobj.NegotiationWindowPopupValidation();
		etendercomponentobj.tenderLogoutOld();
		
		//Ensure suppliers cannot participate in negotiation before the negotiation start date. from Negotiate tab
				etendercomponentobj.commonLogin("tech_auto_01");
				etendercomponentobj.navigate_to_All_Enquiry();
				etendercomponentobj.Negotiate_Tab_Validation();
				etendercomponentobj.NegotiationWindowPopupValidationFromNegotiationTab();
				etendercomponentobj.tenderLogoutOld();
		
		etendercomponentobj.waitTillBidstartDateReached();
			
		//Bid submission of the negotiated bidder from submitted bid tab
		etendercomponentobj.commonLogin("tech_auto_01");
		etendercomponentobj.navigate_to_bidList_page();
		//etendercomponentobj.enterTenderIdInSearch_bidsubmission();
		etendercomponentobj.submittedBid_Tab_Validation();
		...
		//submit bid from negotiatiation tab
		etendercomponentobj.commonLogin("cts_auto_01");
		etendercomponentobj.navigate_to_All_Enquiry();
		etendercomponentobj.NegotiationBid_Tab_Validation();
		etendercomponentobj.BidNoSave();
		etendercomponentobj.TG1_negotiatedBidderSubmission(1);
		etendercomponentobj.submitBid_link_in_previewAllPage();
		etendercomponentobj.navigate_to_bidList_page();
		...
		//Ensure Suppliers should not be able to participate after the negotiation close date.
		etendercomponentobj.commonLogin("tech_auto_01");
		etendercomponentobj.navigate_to_bidList_page();
		etendercomponentobj.submittedBid_Tab_Validation();
		etendercomponentobj.BidNoSave();
		etendercomponentobj.validateNegotiationAfterNegotationEndDate();
		etendercomponentobj.tenderLogoutOld();
		
		//validate total submitted bid count
		etendercomponentobj.tendercreatorLogin();
		etendercomponentobj.navigateToTenderListing();
		etendercomponentobj.enterTenderIdInSearch();
		etendercomponentobj.validatetotalNegotatedBidCount("2");
		etendercomponentobj.tenderLogout();
		
		//validate mail
		rfqfromintendcomponentobj.adminLogin();
		etendercomponentobj.nevigateToMailDetailsNegotiation();
		etendercomponentobj.validateMailAfterSendForApprovalNegotiation();
		etendercomponentobj.tenderLogoutOld();
			
		//increse time and check bidder able to submit bid or not
		etendercomponentobj.tendercreatorLogin();
		etendercomponentobj.navigateToTenderListing();
		etendercomponentobj.enterTenderIdInSearch();
		etendercomponentobj.checkTenderStatusAndTenderStage("Evaluation");
		etendercomponentobj.clickInitiateNegotiationLink();
		//etendercomponentobj.negotiationDetailPageValidation();
		etendercomponentobj.extend_negotiation_dateSchedule(5);
		//Need to write script for Buyer comment and attachment in negotiation.action page
		etendercomponentobj.enterTenderIdInSearch();
		etendercomponentobj.checkTenderStatusAndTenderStageContains("Cover 1 Negotiation");
		etendercomponentobj.tenderLogout();
		...
		//Evaluation: Cover 1 work flow after negotiation
				...
				etendercomponentobj.evaluateSupplier("TCS", "Approve", "Approved with TCS finally", 1);
				etendercomponentobj.enterOverallComment_EvaluatorUser();
				etendercomponentobj.tenderLogoutOld();
		...
		etendercomponentobj.validateTenderEvaluationTabDetails_WithEvaluatorUser();
		etendercomponentobj.clickDetailsLink();
		etendercomponentobj.evaluateSupplier("Tech Mahindra", "Approve", "Approved Tech Mahindra finally", 2);
		etendercomponentobj.evaluateSupplier("CTS", "Approve", "Approved CTS finally", 2);
		etendercomponentobj.evaluateSupplier("TCS", "Approve", "Approved with TCS finally", 2);
		etendercomponentobj.enterOverallComment_EvaluatorUser();
		etendercomponentobj.tenderLogoutOld();
