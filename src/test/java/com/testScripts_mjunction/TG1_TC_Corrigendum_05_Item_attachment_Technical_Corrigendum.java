...
public class TG1_TC_Corrigendum_05_Item_attachment_Technical_Corrigendum extends BaseClass_Web{
	...
	//Create and publish RFQ from indent
		...
		rfqfromintendcomponentobj.PublishTender_from_indent_withRFQ_TG1("Indigenous Tender (Supply & Service Both) V-1.0",5,160,170);
	...
	//Date corrigendum during Live tender status
		...
		etendercomponentobj.enterTenderIdInSearch();
		etendercomponentobj.corrigendum();
		etendercomponentobj.corrigendumSaveButton();
		etendercomponentobj.modifyTemplate();  
	...
	//Verifying pending corrigendum in 2nd approver login and approve the corrigendum 
		...
		//validate corrigendum data at bidder end
		etendercomponentobj.bidder_01_Login();
		etendercomponentobj.navigateToTenderListing();
		etendercomponentobj.enterTenderIdInSearch_bidsubmission();
		...
		etendercomponentobj.navigate_to_bidList_page();
		etendercomponentobj.submittedBid_Tab_Validation();
		etendercomponentobj.validateCorrigendumDataAtBidderEnd();  //validate corrigendum changes at bidder preview
		etendercomponentobj.tenderLogoutOld();
	...
	//Verifying Corrigendum status and corrigendum history
		...
		etendercomponentobj.corrigendumUpdatedValueValidation();
