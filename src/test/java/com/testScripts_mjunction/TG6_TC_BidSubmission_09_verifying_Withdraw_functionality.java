...
public class TG6_TC_BidSubmission_09_verifying_Withdraw_functionality extends BaseClass_Web{
	...
	@Test(description = "Verifying_Withdrawbid_functionality")
	public void Verifying_Withdrawbid_functionality_TG6(String no) throws Throwable {
	...
	//Bid submission procress	
		...
		etendercomponentobj.TG6_validateTenderpreviewInBidListPage();
		etendercomponentobj.TG6_validateBidPreview_BidListPage();
