...
public class TC_EPS_PO_03_Cancelled_Test extends BaseClass_Web {
  ...
  public void f(String no) throws Throwable {
	  ...
	  posttendercomponentobj.sendForApprovalUserDefinedSequentialforCancelPO();
	  etendercomponentobj.tenderLogout();
	  ...
	  posttendercomponentobj.sanction_Creator_Login();
	  posttendercomponentobj.navigateToPurchasrOrderList();
	  posttendercomponentobj.verifyIndentStatusForCancelledOrDeleted("Cancelled");
	  etendercomponentobj.tenderLogout();
