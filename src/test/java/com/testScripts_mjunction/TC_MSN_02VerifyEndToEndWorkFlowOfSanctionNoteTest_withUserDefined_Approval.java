...
public class TC_MSN_02VerifyEndToEndWorkFlowOfSanctionNoteTest_withUserDefined_Approval extends BaseClass_Web{
...
//			ProductionDefectobj.validateMSNStatus("Completed");
			...
			ProductionDefectobj.nevigateToMailForMSN();
			posttendercomponentobj.validateSNMailAfterSendForApproval();
			etendercomponentobj.tenderLogoutOld();
