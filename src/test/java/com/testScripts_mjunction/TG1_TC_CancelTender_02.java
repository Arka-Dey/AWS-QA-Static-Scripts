...
public class TG1_TC_CancelTender_02 extends BaseClass_Web{
...
//Indent assignment Process (self claim)
	...
	//Create and publish RFQ from indent
		...
		rfqfromintendcomponentobj.PublishTender_from_indent_withRFQ_TG1("Indigenous Tender (Supply & Service Both) V-1.0",30,55,56);
		//Clicking on submit button and verify tender status
		etendercomponentobj.clickSubmitBtn();
		etendercomponentobj.tenderIdSave();
		etendercomponentobj.NoApproverWF();
		...
		rfqfromintendcomponentobj.validateCancelledMessage();
