...
public class TG8_TC_TenderCreation_01_tender_publish_with_tender_approval extends BaseClass_Web{
	...
	public void Tenderpublished_after_tender_approval_TG8(String no) throws Throwable {
...
//Creating a new Indent with No approval
	...
	//Create and publish RFQ from indent
		...
		rfqfromintendcomponentobj.PublishTender_from_indent_withRFQ_TG8("Tender for Purchase Contract V-4.0",22,30,40);
	...
	//approving pending tender in 1st approver login	
		...
		etendercomponentobj.TG8_tenderApprover_dynamicity();
