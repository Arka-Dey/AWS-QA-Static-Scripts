...
public class TG5_TC_Negotiation_16_Openingapproval_N_Evaluationapproval_Y_NegotiateOnebidder_ApproveTwobidder extends BaseClass_Web{
	...
	public void Tender_Evaluation_with_OpeningApproval_N_Evaluationapproval_Y_NegotiateOnebidder_ApproveTwobidder_TG5(String no) throws Throwable {
...
//Creating a new Indent with No approval
	...
	//Create and publish RFQ from indent
		...
		rfqfromintendcomponentobj.PublishTender_from_indent_withRFQ_TG5("Indigenous Tender (Supply Only) V-1.0",5,25,26);
	...
	//Evaluation: Cover 2 work flow where opening approval No and evaluation approval Yes
		...
		etendercomponentobj.TG5_negotiatedBidderSubmission();
		etendercomponentobj.navigate_to_bidList_page();
		etendercomponentobj.enterTenderIdInSearch_bidsubmission();
		etendercomponentobj.submittedBid_Tab_Validation();
