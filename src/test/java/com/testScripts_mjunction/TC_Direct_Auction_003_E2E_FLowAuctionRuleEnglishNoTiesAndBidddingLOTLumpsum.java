...
public class TC_Direct_Auction_003_E2E_FLowAuctionRuleEnglishNoTiesAndBidddingLOTLumpsum extends BaseClass_Web {
	...
	@Test(description = "TC_Auction_003:Verify End to End flow with Auction Rule as 'English-No Ties' and bidding type 'LOT_Lumpsum'")
  public void validateAlertEventAlreadyExistedAndAuctionRuleInEventColumnTest(String no) throws Throwable {
	 ...
	 etendercomponentobj.bidder_01_Login();
	  ...
	  auctioncomponentobj.Activate_Aution(AuctionDate);
	  auctioncomponentobj.clickOnDetailsButton(decvalue);
	  auctioncomponentobj.settingNewBidAsRateWise("4500000","4500000","4490000");
	  etendercomponentobj.tenderLogout();
	  
	  etendercomponentobj.bidder_01_Login();
	  auctioncomponentobj.NavigaterToAuctionParcipitation();
	  auctioncomponentobj.clickOnDetailsButton(decvalue);
	  auctioncomponentobj.settingNewBidAsRateWise("4500000","4490000","4490000");
	  etendercomponentobj.tenderLogout();
