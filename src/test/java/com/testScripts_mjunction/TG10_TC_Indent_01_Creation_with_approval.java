...
public class TG10_TC_Indent_01_Creation_with_approval extends BaseClass_Web{
...
//Creating a new Indent with sequential 1 approver userdefined WF
		...
		rfqfromintendcomponentobj.IndentTG1_General_Info_tabvalidation("Indigenous Taxi/Car Hiring Services V-01");
		rfqfromintendcomponentobj.IndentTG10_Indent_Details_tabvalidation();
		rfqfromintendcomponentobj.IndentTG10_Other_Information_tabvalidation();
		rfqfromintendcomponentobj.IndentTG10_Eligibility_Criteria_tabvalidation();
		rfqfromintendcomponentobj.IndentTG10_BOM_Services_tabvalidation();
		rfqfromintendcomponentobj.IndentTG10_EstimationSheet_tabvalidation();
