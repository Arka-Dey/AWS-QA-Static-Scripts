...
public class TG8_TC_Negotiation_16_Openingapproval_N_Evaluationapproval_Y_NegotiateOnebidder_ApproveTwobidder extends BaseClass_Web{
	...
	public void Tender_Evaluation_with_OpeningApproval_N_Evaluationapproval_Y_NegotiateOnebidder_ApproveTwobidder_TG8(String no) throws Throwable {
...
//Creating a new Indent with No approval
	...
	//Evaluation: Cover 2 work flow where opening approval No and evaluation approval Yes
		...
		etendercomponentobj.negotiationDetailPageValidation_new();   //etendercomponentobj.negotiationDetailPageValidation();
		etendercomponentobj.negotiation_dateSchedule(4, 13);
		etendercomponentobj.enterTenderIdInSearch();
		...
		etendercomponentobj.TG8_negotiatedBidderSubmission();
		etendercomponentobj.navigate_to_bidList_page();
		etendercomponentobj.enterTenderIdInSearch_bidsubmission();
		etendercomponentobj.submittedBid_Tab_Validation_new();  //etendercomponentobj.submittedBid_Tab_Validation();
		...
		etendercomponentobj.enterTenderIdInSearch();
		etendercomponentobj.clickEvaluationSettingsLink();
		etendercomponentobj.provideEvaluationCommentsAndConfirmationPopUpValidation_new();  //etendercomponentobj.provideEvaluationCommentsAndConfirmationPopUpValidation();
		etendercomponentobj.enterTenderIdInSearch();
		etendercomponentobj.checktenderStatusIsInevaluationState();
