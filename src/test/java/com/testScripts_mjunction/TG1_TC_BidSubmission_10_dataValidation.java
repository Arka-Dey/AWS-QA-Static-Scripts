...
public class TG1_TC_BidSubmission_10_dataValidation extends BaseClass_Web{
	...
	public void Verifying_Rebid_functionality(String no) throws Throwable {
	...
	//Creating a new Indent with No approval
		...
		etendercomponentobj.bidDetails_Data_Validation();
