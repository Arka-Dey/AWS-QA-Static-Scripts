...
public class TG8_TC_Corrigendum_04_DateCorrigendum_withApproval_Closedstate extends BaseClass_Web{
	...
	public void Date_Corrigendum_approval_closed_state_TG8(String no) throws Throwable {
...
//Creating a new Indent with No approval
	...
	//Create and publish RFQ from indent
		...
		rfqfromintendcomponentobj.PublishTender_from_indent_withRFQ_TG8("Tender for Purchase Contract V-4.0",5,6,40);
