...
public class TG8_TC_BidSubmission_08_verifying_Draftbid_functionality extends BaseClass_Web{
	...
	@Test(description = "Verifying_Draftbid_functionality_RFQ_from_Indent")
	public void Verifying_Draftbid_functionality_TG8(String no) throws Throwable {
...
//Creating a new Indent with No approval
	...
	//Bid submission from draft bid 	
		etendercomponentobj.TG8_Bid_submission_during_Rebid();
		etendercomponentobj.navigate_to_bidList_page();
		etendercomponentobj.enterTenderIdInSearch_bidsubmission();
