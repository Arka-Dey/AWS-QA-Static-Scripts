...
public class TG5_TC_TenderCreation_01_tender_publish_with_tender_approval extends BaseClass_Web{
	...
	public void Tenderpublished_after_tender_approval_TG5(String no) throws Throwable {
...
//Creating a new Indent with No approval
	...
	//Create and publish RFQ from indent
		...
		rfqfromintendcomponentobj.PublishTender_from_indent_withRFQ_TG5("Indigenous Tender (Supply Only) V-1.0",22,30,40);
