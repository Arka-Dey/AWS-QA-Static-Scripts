...
public class TC_MSN_06_Delete_Manual_SN extends BaseClass_Web{
	...
	public void MSN_01VerifyEndToEndWorkFlowOfSanctionNoteTest(String no) throws Throwable {
		...
		etendercomponentobj.tenderLogoutOld();
			...
			ProductionDefectobj.validateMSNStatus("Draft");
			ProductionDefectobj.deleteMSN();
			ProductionDefectobj.varifyDeleteMSN();
			
			ProductionDefectobj.varifyDeletionHistory();  
			etendercomponentobj.tenderLogoutOld();
