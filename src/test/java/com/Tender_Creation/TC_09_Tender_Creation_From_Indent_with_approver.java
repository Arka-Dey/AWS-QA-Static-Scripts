...
public class TC_09_Tender_Creation_From_Indent_with_approver extends BaseClass_Web {
	...
	//approving pending tender in 2nd approver login	
		  ...
		  etendercomponentobj.GoToApprovalworkFlowPendingTendersAndSearchTheTender();
			...
			if (pdfResultReport.testData.get("actionEnabled")=="No") {
				mailAndAttachmentVeification(374 , 1,"Tender approved to tender creator for auction enabled N");
			}
			else {
				mailAndAttachmentVeification(113 , 1,"Tender approved to tender creator for auction enabled Y");
