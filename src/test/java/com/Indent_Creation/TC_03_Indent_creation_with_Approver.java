...
public class TC_03_Indent_creation_with_Approver extends BaseClass_Web {
	...
	public void CreateIndentDynamically(String no)
		...
		mailAndAttachmentVeification(163 , 1,"Approver(s) will get an intimation mail after document is sent for approval");
		//rfqfromintendcomponentobj.navigateToIndentListing();
		rfqfromintendcomponentobj.enterIndentNoInSearch();
		rfqfromintendcomponentobj.VerifyIndentStatus("Pending For Approval");
		ProductionDefectobj.Logout(Dynamicity.getDataFromPropertiesFile("Environment", filePath_4));

		//Login with UserTenderApprover1 
				...
				mailAndAttachmentVeification(165 , 1,"Approver(s) will get an intimation mail after Indent is recalled by the creator");
				ProductionDefectobj.Logout(Dynamicity.getDataFromPropertiesFile("Environment", filePath_4));		
