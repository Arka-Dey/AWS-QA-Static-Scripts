...
public class TC_02_Indent_creation_without_approver extends BaseClass_Web {
	...
	public void CreateIndentDynamically(String no)
		...
		mailAndAttachmentVeification(374 , 1,"Users will get intimation mail after Indent is complete");
		rfqfromintendcomponentobj.VerifyIndentStatus("Completed");
//		rfqfromintendcomponentobj.openIndentPreview();
