...
public class TC_09_Indent_Creation_delete_branch_user extends BaseClass_Web {
	...
	public void CreateIndentDynamically(String no)
		...
		ProductionDefectobj.Logout(Dynamicity.getDataFromPropertiesFile("Environment", filePath_4));
		  ...
		  rfqfromintendcomponentobj.GoToApprovalworkFlowPendingindentAndSearchTheIndent();
			...
			etendercomponentobj.deletebranchUser();
			mailAndAttachmentVeification(267 , 1,"Branch initiator has deleted a branch user who is yet to take his action on Indent document");
