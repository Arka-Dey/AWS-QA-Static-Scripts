...
public class TC_01_Indent_creation_with_multiple_approver extends BaseClass_Web {
	...
	public void CreateIndentDynamically(String no)
		...
		//Approve the created indent and forward-parallel
		...
		etendercomponentobj.provideApproverCommentforTenderApprover();
		etendercomponentobj.tenderApprovalDecision("approve");
		mailAndAttachmentVeification(169 , 1,"Coordinator will get an intimation mail after required min number of approval is reached");
		ProductionDefectobj.Logout(Dynamicity.getDataFromPropertiesFile("Environment", filePath_4));
			
		//Login with test_approver_04 (coordinator)
		...
		//Login with test_approver_07 (coordinator) revert back to previous approver
