...
public class Tender_Fetch_Indent_to_Tender_BidSubmission_FieldDetails extends BaseClass_Web {
	...
	public void CreateIndentDynamically(String no)
		...
		etenderPRcomponentobj.updateIndentTenderBidSubmissionDetails();
