package com.FetchField_Details;
...
public class SN_Fetch_PR_to_SN_FieldDetails extends BaseClass_Web {
	...
	public void CreateSNFromPRDynamically(String no)
		...
		etenderPRcomponentobj.commonLogin(Dynamicity.getDataFromPropertiesFile("snCreator", filePath_4), Dynamicity.getDataFromPropertiesFile("snCreator_Password", filePath_4), "PR", "Creator");
